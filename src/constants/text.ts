...
export const aboutIntro: string = `Hey! my name is <span class="text-green">Cristian</span>, welcome to my website. This is a small side project of mine where I'll be hosting links to some of my more interesting projects as well as ways to get in contact. Still a WIP.`;
...
export const pathfinderProject = {
  ...
  projectDescription:
    "A graphical tool for anyone trying to wrap their heads around a variety of pathfinding algorithms or who wishes to compare how two algorithms work given the same graph layout. Each algorithm is run on a 2d grid where obstacles can be placed and the positions of the start and end positions can be modified. Once started the algorithm will begin to search the grid for the goal node according to its own rules and methods which can be seen in real time.",
  projectTechStack: `
    <ul>
        <li>JavaScript</li> 
        <li>React</li> 
...
export const photoproProject = {
  ...
  projectDescription:
    "A stock image hosting website that learns user behaviour for a more personalised experience. Users can upload a photo of their choosing which will appear on the web app with a watermark applied across the image. Other users may view this stock photo, like, comment and even follow other users if they enjoy their type of content.",
  projectTechStack: `
    <ul>
        <li>Python</li> 
        <li>Flask</li> 
